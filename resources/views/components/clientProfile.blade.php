{!! Form::open(['route' => ['patient.update', 2], 'method' => 'patch']) !!}
...
<div class="container">
    ...
    <div class="form-check">
            {{ Form::label('city', 'Your City', ['class' => 'control-label mt-3']) }}
            {{ Form::text('city', null, ['class' => 'form-control form-control-lg', 'placeholder' => 'Enter Your City']) }}
    </div>

    <div class="form-check">
            {{ Form::label('birthdate', 'Your Birthdate', ['class' => 'control-label mt-3']) }}
            {{ Form::text('birthdate', 'YYYY-MM-DD', ['class' => 'datepicker']) }}
    </div>

    <div class="form-check">
            {{ Form::label('Info About You', 'Addinfo', ['class' => 'control-label mt-3']) }}
